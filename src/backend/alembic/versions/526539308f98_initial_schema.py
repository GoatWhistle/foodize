...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_staff_requests_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["order_id"], ["orders.id"], name=op.f("fk_idempotency_keys_order_id_orders")
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "selection_type", sa.String(length=16), server_default="multiple", nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_menu_item_option_groups_id"), "menu_item_option_groups", ["id"], unique=False
    )
    op.create_table(
        "order_events",
