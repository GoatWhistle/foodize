...
down_revision: Union[str, Sequence[str], None] = 'e70e4ca20f9d'
...
def upgrade() -> None:
    ...
    op.create_check_constraint(
        'total_price_non_negative', 'orders', 'total_price >= 0'
    )
    op.create_index(
    ...
    op.drop_constraint(
        'fk_menu_items_restaurant_id_restaurants', 'menu_items', type_='foreignkey'
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        op.f('ck_orders_total_price_non_negative'), 'orders', type_='check'
    )
