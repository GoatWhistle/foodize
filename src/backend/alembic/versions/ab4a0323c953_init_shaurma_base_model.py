...
def upgrade() -> None:
    ...
    sa.Column('user_role', sa.Enum('CUSTOMER', 'VENDOR', 'ADMIN', name='userrole'), server_default='CUSTOMER', nullable=False),
    ...
    sa.Column('category', sa.Enum('SHAURMA', 'DRINK', 'OTHER', name='category'), nullable=True),
