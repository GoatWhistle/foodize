...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['menu_item_id'], ['menus.id'], name=op.f('fk_order_items_menu_item_id_menus')),
    ...
    sa.Column('user_role', sa.VARCHAR(), server_default=sa.text("'CUSTOMER'::userrole"), autoincrement=False, nullable=False),
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('users_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('hashed_password', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_users'),
    sa.UniqueConstraint('phone_number', name='uq_users_phone_number', postgresql_include=[], postgresql_nulls_not_distinct=False),
    ...
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['vendor_id'], ['vendor_profiles.id'], name='fk_restaurants_vendor_id_vendor_profiles'),
    sa.PrimaryKeyConstraint('id', name='pk_restaurants'),
    sa.UniqueConstraint('address', name='uq_restaurants_address', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('description', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('vendor_profiles_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.UniqueConstraint('user_id', name='uq_vendor_profiles_user_id', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('restaurant_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('is_on_shift', sa.BOOLEAN(), server_default=sa.text('true'), autoincrement=False, nullable=False),
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.UniqueConstraint('user_id', name=op.f('uq_staff_profiles_user_id'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
