...
vi.mock('../../services/aiOrderService', () => ({
  aiOrderService: {
    streamChat: mockStreamChat,
  },
}));

const { default: OrderAssistant } = await import('../../components/ui/OrderAssistant');
...
describe('OrderAssistant', () => {
  ...
  it('sends message on form submit and calls streamChat', async () => {
    ...
    await act(async () => {
      fireEvent.submit(screen.getByPlaceholderText('Что хотите заказать?').closest('form'));
    });
