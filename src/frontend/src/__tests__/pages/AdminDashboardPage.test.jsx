...
beforeEach(() => {
  vi.clearAllMocks();
  adminService.getPlatformStats.mockResolvedValue({ data: { data: STATS } });
  adminService.getUsers.mockResolvedValue({ data: { data: [], total: 0 } });
  adminService.getOrders.mockResolvedValue({ data: { data: [], total: 0 } });
  adminService.getRestaurants.mockResolvedValue({ data: { data: [], total: 0 } });
  adminService.getVendors.mockResolvedValue({ data: { data: [], total: 0 } });
  adminService.getReviews.mockResolvedValue({ data: { data: [], total: 0 } });
  adminService.getFinanceAnalytics.mockResolvedValue({ data: { data: {} } });
  adminService.getAuditLogs.mockResolvedValue({ data: { data: [], total: 0 } });
});
