...
const TabButton = memo(({ tab, activeTab, indented, onClick }) => (
  <button
...
const AdminDashboardPage = () => {
  ...
  const handleTabClick = useCallback((id) => d.setActiveTab(id), [d.setActiveTab]);
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {d.activeTab === 'users' && (
          <AdminUsersTab
            ...
            exportLoading={d.exportLoading}
            handleExport={d.handleExport}
            loadUserDetails={d.loadUserDetails}
        ...
        {d.activeTab === 'restaurants' && (
          <AdminRestaurantsTab
            ...
            exportLoading={d.exportLoading}
            handleExport={d.handleExport}
            loadRestaurantDetails={d.loadRestaurantDetails}
            todayStr={d.todayStr}
            adminService={adminService}
            PAGE_SIZE={PAGE_SIZE}
          />
        ...
        {d.activeTab === 'vendors' && (
          <AdminVendorsTab
            ...
            exportLoading={d.exportLoading}
            handleExport={d.handleExport}
            loadVendorDetails={d.loadVendorDetails}
            todayStr={d.todayStr}
            adminService={adminService}
            PAGE_SIZE={PAGE_SIZE}
          />
        ...
        <AdminDetailModals
          ...
          handleActivateUser={d.handleActivateUser}
          handleDeleteUser={d.handleDeleteUser}
          ...
          handleApproveRestaurant={d.handleApproveRestaurant}
        ...
        <BatchActionBar
          ...
          actions={[
            { label: 'Одобрить выбранных', color: 'var(--color-success)', onClick: () => d.handleBatchVendors('approve') },
            { label: 'Отклонить выбранных', color: 'var(--error)', onClick: () => d.requestReason({ title: 'Причина отклонения', onConfirm: (reason) => d.handleBatchVendors('reject', reason) }) },
          ]}
        />
        ...
        <BatchActionBar
          ...
          actions={[
            { label: 'Одобрить выбранных', color: 'var(--color-success)', onClick: () => d.handleBatchRestaurants('approve') },
            { label: 'Отклонить выбранных', color: 'var(--error)', onClick: () => d.requestReason({ title: 'Причина отклонения', onConfirm: (reason) => d.handleBatchRestaurants('reject', reason) }) },
          ]}
        />
