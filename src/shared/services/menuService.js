...
export const menuService = {
  ...
  updateOptionGroup: (restaurantId, itemId, groupId, data) =>
    api.patch(`/menu/${restaurantId}/items/${itemId}/option-groups/${groupId}`, data),
  deleteOptionGroup: (restaurantId, itemId, groupId) =>
    api.delete(`/menu/${restaurantId}/items/${itemId}/option-groups/${groupId}`),
  createOption: (restaurantId, itemId, groupId, data) =>
    api.post(`/menu/${restaurantId}/items/${itemId}/option-groups/${groupId}/options`, data),
  updateOption: (restaurantId, itemId, groupId, optionId, data) =>
    api.patch(`/menu/${restaurantId}/items/${itemId}/option-groups/${groupId}/options/${optionId}`, data),
  deleteOption: (restaurantId, itemId, groupId, optionId) =>
    api.delete(`/menu/${restaurantId}/items/${itemId}/option-groups/${groupId}/options/${optionId}`),
