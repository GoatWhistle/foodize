...
export interface paths {
    ...
    "/api/v1/admin/orders/{order_id}/cancel": {
        ...
        put?: never;
        /** Force Cancel Order */
        post: operations["force_cancel_order_api_v1_admin_orders__order_id__cancel_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/telegram/refresh": {
        ...
        put?: never;
        /** Telegram Refresh */
        post: operations["telegram_refresh_api_v1_telegram_refresh_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/telegram/session-logout": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Telegram Session Logout */
        post: operations["telegram_session_logout_api_v1_telegram_session_logout_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/telegram/bot/telegram-id": {
        ...
        get?: never;
        put?: never;
        /** Telegram Bot Telegram Id */
        post: operations["telegram_bot_telegram_id_api_v1_telegram_bot_telegram_id_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/notifications/devices": {
        ...
        put?: never;
        /** Register Device */
        post: operations["register_device_api_v1_notifications_devices_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/notifications/devices/{token}": {
        ...
        post?: never;
        /** Unregister Device */
        delete: operations["unregister_device_api_v1_notifications_devices__token__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        SuccessResponse_BatchAffectedResult_: {
            data: components["schemas"]["BatchAffectedResult"];
            meta?: components["schemas"]["Meta"];
        };
        /** SuccessResponse[BatchModerationResult] */
        SuccessResponse_BatchModerationResult_: {
            data: components["schemas"]["BatchModerationResult"];
            meta?: components["schemas"]["Meta"];
        };
        ...
        SuccessResponse_TelegramBotTelegramIdResponse_: {
            data: components["schemas"]["TelegramBotTelegramIdResponse"];
            meta?: components["schemas"]["Meta"];
        };
...
export interface operations {
    ...
    batch_approve_restaurants_api_v1_admin_restaurants_batch_approve_post: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SuccessResponse_BatchModerationResult_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    force_cancel_order_api_v1_admin_orders__order_id__cancel_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ForceCancelOrderRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    telegram_refresh_api_v1_telegram_refresh_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    telegram_session_logout_api_v1_telegram_session_logout_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    telegram_bot_telegram_id_api_v1_telegram_bot_telegram_id_post: {
        parameters: {
            query?: never;
            header?: {
                "X-Telegram-Bot-Secret"?: string;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TelegramBotTelegramIdRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SuccessResponse_TelegramBotTelegramIdResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    register_device_api_v1_notifications_devices_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    unregister_device_api_v1_notifications_devices__token__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
