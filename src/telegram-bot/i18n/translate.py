...
from i18n.types import TranslationNode, TranslationParam, TranslationTree
...
def translate(key: str, language: str = DEFAULT_LANGUAGE, **params: TranslationParam) -> str:
