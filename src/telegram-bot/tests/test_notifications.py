...
async def test_handle_order_placed(mocker):
    ...
    event = {"user_id": "user_1", "restaurant_name": "Cafe", "total_price": 50000, "items_count": 3, "order_display_id": "999"}
...
async def test_handle_order_status_changed(mocker):
    ...
    mock_get_tg.return_value = None
    event = {"user_id": "user_1", "new_status": "READY", "restaurant_name": "Cafe", "total_price": 50000, "order_display_id": "999"}
